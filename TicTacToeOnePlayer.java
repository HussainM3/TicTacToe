// FIX COUNT FOR TIE
// CONTINUE TO WORK ONE ONE PLAYER, PROLLY RANDOM PLACEMENTS
...
*
*/
public class TicTacToeOnePlayer extends JFrame implements ActionListener, MouseListener{
	...
	// method to check if a tie is reached in the game 
	public void checkTie(int count){
		System.out.println("test");
		if (count == 5 && (lblTurn1.isVisible() || lblTurn2.isVisible())) {
System.out.println("test1");
	...
	*/
	public TicTacToeOnePlayer() {
		...
		// add action listeners to click zones
